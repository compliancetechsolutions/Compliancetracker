...
public enum ErrorCode {
  ...
  ENTITY_RELATIONSHIP_TYPE("ENTITY_412_OPT", "Admin Relationship Typr not allowed to be mapped —retry",
      HttpStatus.CONFLICT),

  // ── Notification ─────────────────────────────────────

  NOTIFICATION_NOT_FOUND("NOTIF_404", "Notification not found", HttpStatus.NOT_FOUND),

  NOTIFICATION_SEND_FAILED("NOTIF_500_SEND", "Notification delivery failed", HttpStatus.BAD_GATEWAY),

  NOTIFICATION_INVALID_CHANNEL("NOTIF_400_CHANNEL", "Invalid notification channel", HttpStatus.BAD_REQUEST),

  NOTIFICATION_RETRY_EXHAUSTED("NOTIF_429_RETRY", "Notification retry exhausted", HttpStatus.TOO_MANY_REQUESTS),

  NOTIFICATION_SCHEDULE_INVALID("NOTIF_400_SCHEDULE", "Invalid notification schedule", HttpStatus.BAD_REQUEST),

  NOTIFICATION_ALREADY_SENT("NOTIF_409_SENT", "Notification already processed", HttpStatus.CONFLICT),

  NOTIFICATION_PROVIDER_UNAVAILABLE("NOTIF_503_PROVIDER", "Notification provider unavailable",
      HttpStatus.SERVICE_UNAVAILABLE),

  NOTIFICATION_DLT_FAILED("NOTIF_500_DLT", "Notification moved to dead letter queue",
